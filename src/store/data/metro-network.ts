export const metroNetwork = [
  {
    ...
    segments: [
      ...
      { fromStationId: 3, toStationId: 37, timeMinutes: 7 },
      { fromStationId: 37, toStationId: 38, timeMinutes: 7 },
      { fromStationId: 38, toStationId: 39, timeMinutes: 7 },
    ],
    isCircular: false,
    renderStyle: 'linear',
  },
