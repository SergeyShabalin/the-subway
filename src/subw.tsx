...
const metroNetworkStructure: MetroBranch[] = [
  ...
  },
  {
    ...
    name: 'БКЛ',
    stations: [
      { id: 100001, x: 2033.741019336267, y: -152.49329972338796, color: '#019caa', label: 'Марьина Роща', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100002, x: 2286.776798188771, y: -74.13226479142008, color: '#019caa', label: 'Рижская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100003, x: 2517.0514349715213, y: 56.79194545891812, color: '#019caa', label: 'Сокольники', labelOffset: { x: 20, y: -20 }, branchIds: [4, 11] },
      { id: 100004, x: 2713.797543600434, y: 234.15746046812922, color: '#019caa', label: 'Электрозаводская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100005, x: 2867.8154947036137, y: 449.6708658819938, color: '#019caa', label: 'Лефортово', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100006, x: 2971.9035800661354, y: 693.2549943893057, color: '#019caa', label: 'Авиамоторная', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100007, x: 3021.1947565020446, y: 953.520122865378, color: '#019caa', label: 'Нижегородская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100008, x: 3013.384223384406, y: 1218.2965431665832, color: '#019caa', label: 'Текстильщики', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100009, x: 2948.8371925610163, y: 1475.2036041574927, color: '#019caa', label: 'Печатники', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100010, x: 2830.5718114543056, y: 1712.2286171978612, color: '#019caa', label: 'Нагатинский Затон', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100011, x: 2664.118037842293, y: 1918.288556112302, color: '#019caa', label: 'Кленовый Бульвар', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100012, x: 2457.2590651789938, y: 2083.748287176349, color: '#019caa', label: 'Каширская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100013, x: 2219.6673891189093, y: 2200.871097260731, color: '#019caa', label: 'Варшавская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100014, x: 1962.4525323704263, y: 2264.1804539385557, color: '#019caa', label: 'Каховская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100015, x: 1697.641575761325, y: 2270.7160820548634, color: '#019caa', label: 'Зюзино', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100016, x: 1437.6167853064057, y: 2220.172382902766, color: '#019caa', label: 'Воронцовская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100017, x: 1194.5366312105436, y: 2114.9127236793274, color: '#019caa', label: 'Новаторская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100018, x: 979.7672713150743, y: 1959.8589290621278, color: '#019caa', label: 'Проспект Вернадского', labelOffset: { x: 20, y: -20 }, branchIds: [4, 11] },
      { id: 100019, x: 803.3510821897108, y: 1762.261142157552, color: '#019caa', label: 'Мичуринский проспект', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100020, x: 673.5370887654431, y: 1531.3588158670905, color: '#019caa', label: 'Аминьевская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100021, x: 596.3952490968995, y: 1277.9486863385837, color: '#019caa', label: 'Давыдково', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100022, x: 575.5326298699836, y: 1013.8799295836521, color: '#019caa', label: 'Кунцевская', labelOffset: { x: 20, y: -20 }, branchIds: [4, 2, 15] },
      { id: 100023, x: 611.9247439726105, y: 751.5001071768148, color: '#019caa', label: 'Терехово', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100024, x: 703.8699365962714, y: 503.07780799958596, color: '#019caa', label: 'Мнёвники', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100025, x: 847.0689527236253, y: 280.2289826599397, color: '#019caa', label: 'Народное Ополчение', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100026, x: 1034.825965514833, y: 93.37379455207702, color: '#019caa', label: 'Хорошёвская', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100027, x: 1258.3616657287089, y: -48.750615402703716, color: '#019caa', label: 'ЦСКА', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100028, x: 1507.2237724653376, y: -139.49866775485316, color: '#019caa', label: 'Петровский парк', labelOffset: { x: 20, y: -20 }, branchIds: [4] },
      { id: 100029, x: 1769.775770204083, y: -174.62708443560177, color: '#019caa', label: 'Савёловская', labelOffset: { x: 20, y: -20 }, branchIds: [4, 15] },
    ],
    segments: [
  ...
  },
  {
    ...
    name: 'Кольцевая',
    stations: [
      { id: 501, x: 1256.407724202942, y: 1165.388667959366, color: '#964B00', label: 'Парк культуры', labelOffset: { x: 20, y: -20 }, branchIds: [5, 11] },
      { id: 502, x: 1407.1797726473224, y: 1396.2315574774989, color: '#964B00', label: 'Октябрьская', labelOffset: { x: 20, y: -20 }, branchIds: [5] },
      { id: 503, x: 1656.180288011522, y: 1523.4045934652204, color: '#964B00', label: 'Добрынинская', labelOffset: { x: 20, y: -20 }, branchIds: [5] },
      ...
      { id: 511, x: 1367.6252079090134, y: 633.9736488955838, color: '#964B00', label: 'Краснопресненская', labelOffset: { x: 20, y: -20 }, branchIds: [5] },
      { id: 512, x: 1240.7808912070234, y: 882.7604567784452, color: '#964B00', label: 'Киевская', labelOffset: { x: 20, y: -20 }, branchIds: [5, 2] },
    ],
    segments: [
  ...
  },
  {
    ...
    name: 'МЦД-1',
    stations: [
      { id: 1501, x: 125.47619047619025, y: 1368.809523809523, color: '#fff900', label: 'Одинцово', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1502, x: 203.42948717948684, y: 1305.9661172161163, color: '#fff900', label: 'Баковка', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1503, x: 277.09706959706915, y: 1238.8369963369958, color: '#fff900', label: 'Сколково', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      ...
      { id: 1513, x: 1954.8443223443223, y: -109.95421245421255, color: '#fff900', label: 'Савёловская', labelOffset: { x: 0, y: -60 }, branchIds: [15, 4] },
      { id: 1514, x: 1976.0119047619044, y: -300.29761904761926, color: '#fff900', label: 'Дмитровская', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1515, x: 1972.1794871794868, y: -525.6410256410259, color: '#fff900', label: 'Тимирязевская', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1516, x: 1970.847069597069, y: -678.4844322344323, color: '#fff900', label: 'Петровско-Разумовская', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1517, x: 1972.0146520146513, y: -773.827838827839, color: '#fff900', label: 'Окружная', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1518, x: 1970.6822344322338, y: -869.1712454212455, color: '#fff900', label: 'Дегунино', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1519, x: 1971.8498168498163, y: -954.514652014652, color: '#fff900', label: 'Бескудниково', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1520, x: 1895.5173992673986, y: -1034.8580586080589, color: '#fff900', label: 'Лианозово', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1521, x: 1834.1849816849813, y: -1157.7014652014652, color: '#fff900', label: 'Марк', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1522, x: 1748.0192307692294, y: -1254.044871794872, color: '#fff900', label: 'Новодачная', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1523, x: 1667.0201465201453, y: -1344.8882783882789, color: '#fff900', label: 'Долгопрудная', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1524, x: 1584.687728937728, y: -1429.7316849816852, color: '#fff900', label: 'Водники', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1525, x: 1510.3553113553107, y: -1511.9084249084249, color: '#fff900', label: 'Хлебниково', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1526, x: 1432.022893772893, y: -1599.4184981684982, color: '#fff900', label: 'Шереметьевская', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
      { id: 1527, x: 1351.6904761904752, y: -1632.261904761905, color: '#fff900', label: 'Лобня', labelOffset: { x: 0, y: -60 }, branchIds: [15] },
    ],
    segments: [
